...
class SearchModal extends React.Component {
    ...
    componentDidMount() {
        ...
        this.autocomplete(document.getElementById("myactivity"), activities);
        this.autocomplete(document.getElementById("mylocation"), city_names);
    }
            ...
            <div>
                ...
                <div className='search-modal'>
                    <form className='' onSubmit={this.handleSubmit} autoComplete='off'>
                        ...
                        <button className='btn btn-home-search' type="submit"> Submit</button>
                    </form>
                </div>
            </div>
        )
